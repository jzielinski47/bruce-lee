...
export const levels = [
    ...
    },
    {
        id: 1, sprite: '../assets/map/level_1.png', colliders: [
            ...
            { id: 3, left: 0, right: 0, top: 0, bottom: canvas.height, mode: 'loader', level: 0, dir: 'l' }, // left 
            { id: 4, left: canvas.width, right: canvas.width, top: 0, bottom: canvas.height, mode: 'loader', level: 2, dir: 'r' },
            { id: 5, left: 0, right: canvas.width, top: canvas.height, bottom: canvas.height, mode: 'loader', level: 3, dir: 'd', hatch: { left: 0, right: 0 } },
            { id: 6, left: 152, right: 168, top: canvas.height - 10, bottom: canvas.height, mode: 'door', opened: true }
        ]
    },
    {
