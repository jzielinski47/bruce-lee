...
export const levels = [
    ...
    },
    {
        id: 3, sprite: '../assets/map/level_3.png', colliders: [
            ...
            { id: 3, name: 'loader', dir: 'custom', x: 0, y: 0, width: 0, height: canvas.height, mode: 'loader', level: 4, custom: { x: 0, y: 0 } },
    ...
    },
    {
        id: 4, sprite: '../assets/map/level_4.png', colliders: [
            ...
            { id: 0, name: 'fence', x: 40, y: 62, width: 8, height: 114 },
            { id: 0, name: 'fence', x: 0, y: 14, width: 8, height: canvas.height },
            { id: 0, name: 'fence', x: 192, y: 0, width: 128, height: 8 },
            ...
            // { id: 0, name: 'platform', x: 272, y: 60, width: 8, height: 2 },
            // { id: 0, name: 'platform', x: 40, y: 60, width: 8, height: 2 },
            // { id: 0, name: 'platform', x: canvas.width - 8, y: 60, width: 8, height: 2 },
            { id: 0, name: 'fence', x: canvas.width - 8, y: 62, width: 8, height: 92 },
            { id: 0, name: 'fence', x: 272, y: 62, width: 8, height: 58 },
            { id: 0, name: 'fence', x: 0, y: 0, width: 128, height: 8 },
