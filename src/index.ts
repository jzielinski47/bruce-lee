...
export const player = new Player({ position: { x: 30, y: 150 }, velocity: { x: 0, y: 0 }, scale: { width: 15, height: 22 } },
    {
        ...
        jumpLeft: { frameRate: 2, frameBuffer: 2, loop: true, imageSrc: '../assets/sprites/brucelee/jumpLeft.png' },
        jumpRight: { frameRate: 2, frameBuffer: 2, loop: true, imageSrc: '../assets/sprites/brucelee/jumpRight.png' },
