...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"gravityScale\": () => (/* binding */ gravityScale),\n/* harmony export */   \"input\": () => (/* binding */ input),\n/* harmony export */   \"lastKey\": () => (/* binding */ lastKey),\n/* harmony export */   \"player\": () => (/* binding */ player),\n/* harmony export */   \"velocity\": () => (/* binding */ velocity)\n/* harmony export */ });\n/* harmony import */ var _setup__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./setup */ \"./src/setup.ts\");\n/* harmony import */ var _sprites_Player__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./sprites/Player */ \"./src/sprites/Player.ts\");\n/* harmony import */ var _sprites_Scene__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./sprites/Scene */ \"./src/sprites/Scene.ts\");\n// import { input, lastKey } from \"./inputListener\";\r\n\r\n\r\n\r\nconst gravityScale = 0.2;\r\nconst velocity = 1.2;\r\nconst player = new _sprites_Player__WEBPACK_IMPORTED_MODULE_1__.Player({ position: { x: 30, y: 150 }, velocity: { x: 0, y: 0 }, scale: { width: 16, height: 22 } });\r\nconst scene = new _sprites_Scene__WEBPACK_IMPORTED_MODULE_2__.Scene({ position: { x: 0, y: 0 }, scale: { width: _setup__WEBPACK_IMPORTED_MODULE_0__.canvas.width, height: _setup__WEBPACK_IMPORTED_MODULE_0__.canvas.height } }, { texture: '../assets/map/test.png' });\r\nconst input = {\r\n    a: { pressed: false },\r\n    d: { pressed: false },\r\n    w: { pressed: false },\r\n    s: { pressed: false },\r\n};\r\nlet lastKey;\r\nfunction update() {\r\n    window.requestAnimationFrame(update);\r\n    scene.update();\r\n    player.update();\r\n    player.velocity.x = 0;\r\n    if (input.a.pressed && lastKey === 'a')\r\n        player.velocity.x = -velocity;\r\n    else if (input.d.pressed && lastKey === 'd')\r\n        player.velocity.x = velocity;\r\n}\r\nupdate();\r\nwindow.onkeydown = e => {\r\n    switch (e.key) {\r\n        case \"a\":\r\n        case \"ArrowLeft\":\r\n            input.a.pressed = true;\r\n            lastKey = 'a';\r\n            break;\r\n        case \"d\":\r\n        case \"ArrowRight\":\r\n            input.d.pressed = true;\r\n            lastKey = 'd';\r\n            break;\r\n        case \"w\":\r\n        case \"ArrowUp\":\r\n            player.velocity.y = -2;\r\n            break;\r\n    }\r\n};\r\nwindow.onkeyup = e => {\r\n    switch (e.key) {\r\n        case \"a\":\r\n        case \"ArrowLeft\":\r\n            input.a.pressed = false;\r\n            break;\r\n        case \"d\":\r\n        case \"ArrowRight\":\r\n            input.d.pressed = false;\r\n            break;\r\n    }\r\n};\r\n\n\n//# sourceURL=webpack://bruce-lee/./src/index.ts?");
